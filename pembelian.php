...
?>
<h2 class="ml-5 text-2xl text-gray-700 tracking-widest uppercase text-bold mt-12 font-bold">Input Pembelian</h2>
<div class="mx-5 mt-10">
    <form action="pembelian/pembelian_action.php" method="post">
        <div>
            <label for="barang">
